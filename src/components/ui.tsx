...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center" role="dialog" aria-modal="true">
      ...
      <div
        className={`relative z-10 max-h-[90vh] w-full overflow-y-auto rounded-t-3xl bg-white p-5 shadow-2xl dark:bg-slate-900 sm:rounded-2xl ${
...
export function Drawer({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end" role="dialog" aria-modal="true">
      ...
      <div className="relative z-10 w-full max-w-md bg-white shadow-2xl h-full flex flex-col dark:bg-slate-900 animate-slide-in-right">
